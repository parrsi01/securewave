...
Reads chaos artifacts and compares recovery-related metrics against `chaos/chaos_thresholds.json`.
...
def main() -> int:
    ...
    parser.add_argument("--thresholds", default=str(REPO_ROOT / "chaos" / "chaos_thresholds.json"))
