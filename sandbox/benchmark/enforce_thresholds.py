...
Reads benchmark artifacts and compares computed metrics against `benchmarks/thresholds.json`.
...
def main() -> int:
    ...
    parser.add_argument("--thresholds", default=str(REPO_ROOT / "benchmarks" / "thresholds.json"))
