...
- Run ID: `20260227_005030`
- Output dir: `/home/sp/cyber-course/projects/securewave/tools/runtime_probe/out/20260227_005030`

## Summary Verdicts

- Connect command exit status: **1**
- Disconnect command exit status: **0**
...
| `ip route get 1.1.1.1` iface | `enp0s1` | `enp0s1` |
| Egress IP (ipify) | `92.105.134.148` | `92.105.134.148` |
