...
SecureWave should not be described as a production-scale SaaS, multi-platform VPN, or paid subscription product currently live unless separate release evidence exists. Public messaging should describe the current truth: Linux desktop free release candidate now, Apple/iOS packaging in Mac handoff, Premium coming soon, and additional platforms/protocols gated by future validation.
