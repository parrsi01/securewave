...
- Generated (UTC): `2026-02-21T22:17:47.175897+00:00`
- Host platform: `linux`
- Output directory: `/home/sp/cyber-course/projects/securewave/artifacts/live_validation_multi_protocol/20260221_221747`
...
## Mock/Demo Scan
- Runtime path hits: **0**
- Workflow/config hits: **4**
- Runtime scan passed: no mock/demo flags detected in runtime code paths.
- Workflow/config references detected (review required):
  - `.github/workflows/flutter-release.yml:29` => `DEMO_MODE: "false"`
  - `.github/workflows/flutter-release.yml:30` => `WG_MOCK_MODE: "false"`
  - `.github/workflows/test.yml:18` => `DEMO_MODE: "true"`
  - `.github/workflows/test.yml:19` => `WG_MOCK_MODE: "true"`
...
1. WireGuard (data-plane):
   - `sudo cp artifacts/live_validation_multi_protocol/20260221_221747/raw_logs/wireguard_linux.conf /etc/wireguard/sw-live.conf`
...
2. OpenVPN (data-plane):
   - `sudo openvpn --config artifacts/live_validation_multi_protocol/20260221_221747/raw_logs/openvpn_linux.ovpn --daemon --writepid /tmp/sw-ovpn.pid --log /tmp/sw-ovpn.log`
   - `ip addr show tun0`
