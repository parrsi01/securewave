...
DEFAULT_DOWNLOAD_MANIFEST = [
    ...
    # Linux
    {
        ...
        "notes": "Withheld until rebuilt from the reviewed current source and accepted clean x86_64 VM/login evidence; the historical workflow package is not current release evidence.",
    },
    {
        "platform": "linux",
        "architecture": "x64",
    ...
    },
    {
        ...
        "status": "coming_soon",
        "notes": "Withheld until rebuilt from the reviewed live-only source; the tracked artifact contains historical template API configuration.",
    },
    {
        "platform": "linux",
        "architecture": "arm64",
