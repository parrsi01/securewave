...
- On a Mac, run `securewave_app/scripts/package_macos_ui_demo.sh` and publish the generated `securewave-macos-*-ui-demo.zip` to make the macOS demo app download live.
