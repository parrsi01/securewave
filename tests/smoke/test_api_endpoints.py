...
class TestAuthEndpoints:
    ...
    def test_login_rejects_empty_body(self, client: TestClient):
    ...
    def test_register_rejects_empty_body(self, client: TestClient):
    ...
    def test_password_reset_request_accepts_email(self, client: TestClient):
...
class TestAuthenticatedEndpoints:
    ...
    def test_vpn_servers_public(self, client: TestClient):
        # Server list may be public for discovery
        response = client.get("/api/vpn/servers")
        assert response.status_code in (200, 401, 403)

    def test_devices_requires_auth(self, client: TestClient):
...
class TestAuthenticatedUserEndpoints:
    ...
    def test_me_returns_user_info(self, client: TestClient, auth_headers):
    ...
    def test_vpn_servers_list(self, client: TestClient, auth_headers):
    ...
    def test_devices_list(self, client: TestClient, auth_headers):
...
class TestAdminEndpoints:
    ...
    def test_admin_servers_requires_admin(self, client: TestClient, auth_headers):
        response = client.get("/api/admin/servers", headers=auth_headers)
        # Regular user should be forbidden
        assert response.status_code in (403, 401)

    def test_admin_servers_allowed_for_admin(self, client: TestClient, admin_auth_headers):
...
class TestContactEndpoint:
    ...
    def test_contact_rejects_empty_body(self, client: TestClient):
...
class TestSecurityHeaders:
    ...
    def test_request_id_returned(self, client: TestClient):
        response = client.get("/api/health")
...
class TestErrorResponses:
    ...
    def test_404_returns_json_for_api(self, client: TestClient):
