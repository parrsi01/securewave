# SecureWave - Historical Candidate Evidence

Archived 2026-09-08. Deployment failures and checksums below include superseded
observations. See [current status](current_release_status.md) before release work.
