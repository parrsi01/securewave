...
`.release.json`, applies existing Alembic migrations, validates published
download artifacts, atomically activates the release, and verifies public
health, readiness, downloads, version, and exact commit identity. A failed
