...
{
public:
    scoped_padder(size_t wrapped_size,
...
// Full weekday name
static std::array<const char*, 7> full_days{{"Sunday",
                                             "Monday",
                                             "Tuesday",
                                             "Wednesday",
                                             "Thursday",
...
// Abbreviated month
static const std::array<const char*, 12> months{{"Jan",
                                                 "Feb",
                                                 "Mar",
                                                 "Apr",
                                                 "May",
...
public:
                ...
                memory_buf_t& dest) override
    {
        ...
        fmt_helper::append_string_view(
            days[static_cast<size_t>(tm_time.tm_wday)],
            dest);
        dest.push_back(' ');
        fmt_helper::append_string_view(
            months[static_cast<size_t>(tm_time.tm_mon)],
            dest);
        dest.push_back(' ');
...
#pragma warning(disable : 4127) // consider using 'if constexpr' instead
    ...
    static const char* basename(const char* filename)
    {
        ...
        else
        {
            ...
            const auto it = std::find_first_of(begin,
                                               end,
                                               std::begin(os::folder_seps),
...
// some message
#ifndef SPDLOG_NO_TLS
template <typename ScopedPadder> class mdc_formatter : public flag_formatter
{
public:
    ...
    details::padding_info padding)
{
    ...
    switch (flag)
    {
        ...
        case ('u'): // elapsed time since last log message in nanos
            formatters_.push_back(
                details::make_unique<
                    details::elapsed_formatter<Padder,
