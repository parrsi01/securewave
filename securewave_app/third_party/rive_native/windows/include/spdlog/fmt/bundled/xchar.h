...
struct format_string_char<
    S,
    void_t<decltype(sizeof(detail::to_string_view(std::declval<S>())))>>
{
    using type = char_t<S>;
};
...
struct format_string_char<
    S,
    enable_if_t<std::is_base_of<detail::compile_string, S>::value>>
{
...
auto join(Range&& range, wstring_view sep)
    -> join_view<decltype(std::begin(range)),
...
template <typename... T>
FMT_DEPRECATED void print(text_style ts,
                          wformat_string<T...> fmt,
                          const T&... args)
{
