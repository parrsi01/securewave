...
FMT_FUNC void do_report_error(format_func func,
                              int error_code,
...
{
    return val.visit(detail::loc_writer<>{out,
                                          specs,
                                          separator_,
                                          grouping_,
                                          decimal_point_});
...
FMT_FUNC void vformat_to(buffer<char>& buf,
                         string_view fmt,
                         format_args args,
                         locale_ref loc)
{
...
FMT_FUNC void vprint_mojibake(std::FILE* f,
                              string_view fmt,
                              format_args args,
                              bool newline)
{
