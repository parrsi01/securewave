...
template <typename Mutex> class qt_color_sink : public base_sink<Mutex>
{
public:
...
{
    return Factory::template create<sinks::qt_sink_mt>(logger_name,
                                                       qt_object,
                                                       meta_method);
}
...
inline std::shared_ptr<logger> qt_logger_st(
    ...
    const std::string& meta_method = "append")
{
    return Factory::template create<sinks::qt_sink_st>(logger_name,
                                                       qt_object,
                                                       meta_method);
}
...
inline std::shared_ptr<logger> qt_color_logger_mt(
    ...
    bool is_utf8 = false)
{
    return Factory::template create<sinks::qt_color_sink_mt>(logger_name,
                                                             qt_text_edit,
                                                             max_lines,
                                                             false,
                                                             is_utf8);
...
inline std::shared_ptr<logger> qt_color_logger_st(
    ...
    bool is_utf8 = false)
{
    return Factory::template create<sinks::qt_color_sink_st>(logger_name,
                                                             qt_text_edit,
                                                             max_lines,
                                                             false,
                                                             is_utf8);
