  ...
  void _updateStep(String label, bool success) {
    ...
    setState(() {
      if (_steps.isNotEmpty) {
        _steps[_steps.length - 1] = _PanicStep(
          label: label,
          completed: success,
        );
      }
        ...
        child: ListView(
          children: [
            const SwSectionHeader(
              ...
              subtitle:
                  'A safe, reversible sequence that disconnects the VPN, clears session tokens, rotates server preference, and signs you out.',
            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const _StepNumbered(
                        1,
                        'Instantly disconnects the VPN tunnel.',
                      ),
                      const _StepNumbered(
                        2,
                        'Clears your cached tunnel profile data.',
                      ),
                      const _StepNumbered(
                        3,
