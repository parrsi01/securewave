...
build_macos() {
  ...
  echo "  3. Run: cd securewave_app && flutter build macos --release"
  echo "  4. Create a .dmg from the .app bundle"
  echo "  5. Sign and notarize with your Apple Developer certificate"
  echo "  6. Copy the .dmg to static/downloads/securewave-macos-arm64.dmg"
  echo ""
}
