...
def _run_command(
    *,
    ...
    command_env = {
        **os.environ,
        **(env or {}),
        # Keep generated bytecode out of an iCloud/offloaded checkout.  Python
        # otherwise attempts to read stale data-less .pyc files before the
        # tracked source, which can block a bounded local workflow.
