...
Reads leak artifacts and compares derived scores against `dev_tools/leak/leak_thresholds.json`.
...
# dev_tools/sandbox/leak_tests/* -> repo root is 3 levels up
...
def main() -> int:
    ...
    parser.add_argument("--thresholds", default=str(REPO_ROOT / "dev_tools" / "leak" / "leak_thresholds.json"))
