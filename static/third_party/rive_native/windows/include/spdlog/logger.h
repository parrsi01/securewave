...
public:
             ...
             wstring_view_t msg)
    {
        ...
        details::os::wstr_to_utf8buf(wstring_view_t(msg.data(), msg.size()),
                                     buf);
        details::log_msg log_msg(log_time,
                                 loc,
                                 name_,
                                 lvl,
...
protected:
              ...
              Args&&... args)
    {
        ...
        SPDLOG_TRY
        {
            ...
            fmt_lib::vformat_to(std::back_inserter(buf),
                                fmt,
              ...
              Args&&... args)
    {
        ...
        SPDLOG_TRY
        {
            ...
            details::os::wstr_to_utf8buf(
                wstring_view_t(wbuf.data(), wbuf.size()),
                buf);
            details::log_msg log_msg(loc,
                                     name_,
                                     lvl,
